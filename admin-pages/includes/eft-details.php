...
<form method="POST" action="">
    <table class="form-table">
        <tr>
            <th scope="row">
                <label for="account_name"><?php _e('Account Name', 'textdomain'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th scope="row">
                <label for="account_number"><?php _e('Account Number', 'textdomain'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th scope="row">
                <label for="bank_name"><?php _e('Bank Name', 'textdomain'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th scope="row">
                <label for="branch_code"><?php _e('Branch Code', 'textdomain'); ?></label>
            </th>
            <td>
