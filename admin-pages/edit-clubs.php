...
$payment_gateway = $club_id ? get_payment_gateway($club_id) : null;
...
<div class="wrap woocommerce">
    ...
    <a href="#add-members-modal" class="sub-tab" id="add-club-member-tab"><?php _e('Add Club Member', 'club-manager'); ?></a>
</div>
    ...
    <p class="form-row form-row-wide">
        <label for="club_name" style="padding-right: 50px;"><?php _e('Club Name', 'club-manager'); ?></label>
        <input type="text" class="input-text" name="club_name" id="club_name" value="<?php echo esc_attr($club ? $club->club_name : ''); ?>" required style="width: 300px;" />
    </p>
    
    <!-- Home URL -->
    <p class="form-row form-row-wide">
        <label for="club_url" style="padding-right: 50px;"><?php _e('Home URL', 'club-manager'); ?></label>
        <input type="text" class="input-text" name="club_url" id="club_url" value="<?php echo esc_attr($club ? $club->club_url : ''); ?>" required style="width: 300px;" />
    </p>
    
    <!-- Club Logo Upload -->
    <p class="form-row form-row-wide">
        <label for="club_logo" style="padding-right: 50px;"><?php _e('Logo', 'club-manager'); ?></label>
    ...
    <p class="form-row" style="margin-bottom: 20px;">
        <label for="eft_account_name" style="display: inline-block; width: 150px; padding-right: 20px;"><?php _e('Account Name', 'club-manager'); ?></label>
        <input type="text" class="input-text" name="eft_account_name" id="eft_account_name" value="<?php echo esc_attr($eft_details ? $eft_details->account_name : ''); ?>" style="width: 300px; height: 30px; padding: 4px 8px; border: 1px solid #ccc; border-radius: 4px;" />
    </p>
    
    <!-- Account Number -->
    <p class="form-row" style="margin-bottom: 20px;">
        <label for="eft_account_number" style="display: inline-block; width: 150px; padding-right: 20px;"><?php _e('Account Number', 'club-manager'); ?></label>
        <input type="text" class="input-text" name="eft_account_number" id="eft_account_number" value="<?php echo esc_attr($eft_details ? $eft_details->account_number : ''); ?>" style="width: 300px; height: 30px; padding: 4px 8px; border: 1px solid #ccc; border-radius: 4px;" />
    </p>
    
    <!-- Bank Name -->
    <p class="form-row" style="margin-bottom: 20px;">
        <label for="eft_bank_name" style="display: inline-block; width: 150px; padding-right: 20px;"><?php _e('Bank Name', 'club-manager'); ?></label>
        <input type="text" class="input-text" name="eft_bank_name" id="eft_bank_name" value="<?php echo esc_attr($eft_details ? $eft_details->bank_name : ''); ?>" style="width: 300px; height: 30px; padding: 4px 8px; border: 1px solid #ccc; border-radius: 4px;" />
    </p>
    
    <!-- Branch Code -->
    <p class="form-row" style="margin-bottom: 20px;">
        <label for="eft_branch_code" style="display: inline-block; width: 150px; padding-right: 20px;"><?php _e('Branch Code', 'club-manager'); ?></label>
        <input type="text" class="input-text" name="eft_branch_code" id="eft_branch_code" value="<?php echo esc_attr($eft_details ? $eft_details->branch_code : ''); ?>" style="width: 300px; height: 30px; padding: 4px 8px; border: 1px solid #ccc; border-radius: 4px;" />
    </p>
                </div>
    ...
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo ea, ratione officia voluptatum vitae aliquam.</p>

    <!-- Select Payment Gateway -->
    <p class="form-row form-row-wide" style="margin-bottom: 20px;">
        <label for="payment_gateway" style="display: inline-block; width: 200px; padding-right: 20px;"><?php _e('Select Payment Gateway', 'club-manager'); ?></label>
        <select name="payment_gateway" id="payment_gateway" style="width: 320px; height: 30px; padding: 4px 8px; border: 1px solid #ccc; border-radius: 4px;">
    ...
    <div id="payfast_fields" style="display: none;">
        <p class="form-row form-row-wide" style="margin-bottom: 20px;">
            <label for="payfast_merchant_id" style="display: inline-block; width: 200px; padding-right: 20px;"><?php _e('Merchant ID', 'club-manager'); ?></label>
            <input type="text" class="input-text" name="payfast_merchant_id" id="payfast_merchant_id" style="width: 320px; height: 30px; padding: 4px 8px; border: 1px solid #ccc; border-radius: 4px;" />
        </p>
        <p class="form-row form-row-wide" style="margin-bottom: 20px;">
            <label for="payfast_merchant_key" style="display: inline-block; width: 200px; padding-right: 20px;"><?php _e('Merchant Key', 'club-manager'); ?></label>
            <input type="text" class="input-text" name="payfast_merchant_key" id="payfast_merchant_key" style="width: 320px; height: 30px; padding: 4px 8px; border: 1px solid #ccc; border-radius: 4px;" />
        </p>
    </div>
    ...
    <div id="stripe_fields" style="display: none;">
        <p class="form-row form-row-wide" style="margin-bottom: 20px;">
            <label for="stripe_api_key" style="display: inline-block; width: 200px; padding-right: 20px;"><?php _e('API Key', 'club-manager'); ?></label>
            <input type="text" class="input-text" name="stripe_api_key" id="stripe_api_key" style="width: 320px; height: 30px; padding: 4px 8px; border: 1px solid #ccc; border-radius: 4px;" />
        </p>
        <p class="form-row form-row-wide" style="margin-bottom: 20px;">
            <label for="stripe_secret_key" style="display: inline-block; width: 200px; padding-right: 20px;"><?php _e('Secret Key', 'club-manager'); ?></label>
            <input type="text" class="input-text" name="stripe_secret_key" id="stripe_secret_key" style="width: 320px; height: 30px; padding: 4px 8px; border: 1px solid #ccc; border-radius: 4px;" />
        </p>
    </div>
    ...
    <div id="yoco_fields" style="display: none;">
        <p class="form-row form-row-wide" style="margin-bottom: 20px;">
            <label for="yoco_link" style="display: inline-block; width: 200px; padding-right: 20px;"><?php _e('Yoco Link', 'club-manager'); ?></label>
            <input type="text" class="input-text" name="yoco_link" id="yoco_link" style="width: 320px; height: 30px; padding: 4px 8px; border: 1px solid #ccc; border-radius: 4px;" />
        </p>
    </div>
